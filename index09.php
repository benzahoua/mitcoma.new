...
<!-- Navigation -->
	...
	<div class="navigation">
		...
		<div class="container">
			<div class="logo"><a href="index.php"><img src="images/spacer.png" class="white mt5 relative z100" alt=""/></a></div>
	...
	<div class="tp-banner" >
		<ul>
			...
			<li  data-transition="fade" data-slotamount="1" data-masterspeed="2000" data-thumb="images/slider/girls.jpg" data-delay="12000"  data-saveperformance="on"  data-title="Ken Burns Slide" data-color="white">
				<!-- MAIN IMAGE -->
				<img src="images/dummy.png" data-lazyload="images/slider/girls.jpg" data-bgposition="top center" data-bgpositionend="top center" alt="" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="100" data-bgfitend="100">
				...
				<div class="tp-caption "
					...
					<!-- LAYER 1 -->
					<div class="prlx-on tp-caption fontproximabold size50 cwhite customin customout tp-resizeme"
						...
						data-endspeed="300"
						style="z-index: 10;"
						>For the creatives ones
					</div>
					
					<!-- LAYER 2 -->
					<div class="prlx-on tp-caption fontproximalight size30 cwhite randomrotate customout tp-resizeme"
						...
						data-endspeed="100"
						style="z-index: 10;"
						>For your agency, your app, your business, or your portfolio.
					</div>
					
					<!-- LAYER 3 -->
					<div class="prlx-on tp-caption caption-white-bold-caps customin  stl"
						...
						<div class="container rev-ct1">
							...
							<div class="col-md-6">
								<a class="btn btnwhiteline2 fontproximabold plr50 caps rev-r activate-tmprev">Browse more pages</a>
							</div>
						</div>
					</div>	
...
<!-- 3 COLS -->
<div id="navoffset" class="container-fluid bgmaincolor cwhite relative z100">
	<div class="container mtb40">
		<div class="row">

			<div class="col-md-4 text-center">
				<div class="circlebigwhite center mb10"><i class="icon-magic size20"></i></div>
				<h4 class="uppercase fontproximabold">Amazing design quality</h4>
				<p>Nice colors, great balance, sharp details, functionality and a little bit of creativity  makes awesome aesthetics.</p>
				<a href="#" class="btn btnwhite2 btn-default mb10"><i class="icon-article-alt"></i> Read more</a>
			</div>
			<div class="col-md-4 text-center">
				<div class="circlebigwhite center mb10"><i class="icon-equalizer size20"></i></div>
				<h4 class="uppercase fontproximabold">intuitive design</h4>
				<p>You will be surprised how stupid siple is to customize your theme especially with a proper ducumentation.</p>
				<a href="#" class="btn btnwhite2 btn-default mb10"><i class="icon-article-alt"></i> Read more</a>
			</div>
			<div class="col-md-4 text-center">
				<div class="circlebigwhite center mb10"><i class="icon-mobile size20"></i></div>
				<h4 class="uppercase fontproximabold">responsive</h4>
				<p>Whether you look on the tablet, smartphone or desktop, your site will look flawless.</p>
				<a href="#" class="btn btnwhite2 btn-default mb10"><i class="icon-article-alt"></i> Read more</a>
			</div>
...
<div class="separator100 relative none z100"></div>

<!-- PORTFOLIO SECTION-->
<div class="bgmaincolordarken cwhite relative z100">
	<div class="container-fluid offset-0 pt50">
		
			<h3 class="text-center caps pb20 fontproxima">Some of our recent work</h3>
			
			<div class="bgblue">
				<ul class="pgal">
					<li><img src="images/pgal/thumb01.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li class="pgalhide2"><img src="images/pgal/thumb02.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li class="pgalhide"><img src="images/pgal/thumb03.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li><img src="images/pgal/thumb04.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li><img src="images/pgal/thumb05.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li><img src="images/pgal/thumb06.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li><img src="images/pgal/thumb07.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li class="pgalhide2"><img src="images/pgal/thumb08.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li class="pgalhide"><img src="images/pgal/thumb09.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
					</li>
					<li class="times2 bgmaincolor custpos01 relative">
					...
					<li><img src="images/pgal/thumb10.jpg" class="zoom" alt="" />
						<div class="pgal-hover">
							<h4>Nice Branding</h4><span></span><p>Creative</p>
							<a class="btnmore" href="#"><i class="glyphicon glyphicon-plus"></i></a>
						</div>
			...
			<ul class="services">
				<li class="col-md-4 col-sm-6 col-xs-12 text-center">
					<a>
						...
						<h4 class="uppercase titlefont mtb10">intuitive design</h4>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit Expedita voluptatum necessitatibus deleniti nisi inventore non quis saepe 
					</a>
				</li>
				<li class="col-md-4 col-sm-6 col-xs-12 text-center">
					<a>
						<i class="icon-cup size50 lh50 clightgrey"></i>
						<h4 class="uppercase titlefont mtb10">intuitive design</h4>
						Provident, asperiores, optio dolorum veritatis nobis Expedita voluptatum necessitatibus deleniti nisi inventore non quis saepe
					</a>
				</li>
				<li class="col-md-4 col-sm-6 col-xs-12 text-center">
					<a>
						...
						<h4 class="uppercase titlefont mtb10">intuitive design</h4>
						Expedita voluptatum necessitatibus deleniti nisi inventore non quis saepe rerum illo eos laboriosam a explicabo iure.
					</a>
				</li>
				<li class="col-md-4 col-sm-6 col-xs-12 text-center">
					<a>
...
<section class="bgmaincolor cwhite relative z100 clearfix">
	...
	<div class="container cus-pos-abs">
		...
		<div class="cover-right-text col-sm-12 col-sm-offset-0 col-md-6 col-md-offset-6 sspacing">
			<h1 class="titlefont cwhite caps">Welcome to Avision</h1>
			<p class="size20 mt20">
				The profesional business template that once you've seen it you will never forget. 
			</p>
			<div class="separator100 bgwhite mtb30"></div>
			<ul class="aboutteamlist">
				<li>
					<div class="cwhite circlesmall light left"><i class="icon-magic"></i></div>
					<div class="ctnr">
						<h4 class="cwhite uppercase mb15">Amazing Design</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro, magni, sint sunt totam impedit doloribus.</p>
					</div>
				</li>

				<li>				
					<div class="cwhite circlesmall light left"><i class="icon-equalizer"></i></div>
					<div class="ctnr">
						<h4 class="cwhite uppercase mb15">Intuitive</h4>
						<p>Placeat dolorum expedita modi corporis molestias fuga consectetur pariatur dolorem neque deserunt sint odio.</p>			
					</div>
				</li>

				<li>				
					<div class="cwhite circlesmall light left"><i class="icon-mobile"></i></div>
					<div class="ctnr">
						<h4 class="cwhite uppercase mb15">Responsive</h4>		
						<p>Placeat dolorum expedita modi corporis molestias fuga consectetur pariatur dolorem neque deserunt sint odio.</p>
					</div>
				</li>				
				
				<li>				
					<div class="cwhite circlesmall light left"><i class="icon-aperture"></i></div>
					<div class="ctnr">
						<h4 class="cwhite uppercase mb15">Retina Ready</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Porro, magni, sint sunt totam impedit doloribus.</p>	
					</div>	
				</li>
			</ul>			
		...
		<div class="row">
			...
			<div class="col-md-3" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
				<div class="player offset-0" data-scrollreveal="enter left">
					...
					<div class="teampicture">
						<img src="images/team1.jpg" class="fwi dajy" alt=""/>
			...
			<div class="col-md-3" data-scroll-reveal="enter top over 1s and move 50px after 0.5s">
				<div class="player offset-0" data-scrollreveal="enter top">
					...
					<div class="teampicture">
						<img src="images/team2.jpg" class="fwi dajy" alt=""/>
						<div class="teamover"></div>
						<p>Web Developer</p>
					</div>
					<div class="socialiconswhite m20">
			...
			<div class="col-md-3" data-scroll-reveal="enter bottom over 1s and move 50px after 0.5s">
				<div class="player offset-0" data-scrollreveal="enter bottom">
					...
					<div class="teampicture">
						<img src="images/team3.jpg" class="fwi dajy" alt=""/>
						<div class="teamover"></div>
			...
			<div class="col-md-3" data-scroll-reveal="enter right over 1s and move 300px after 0.5s">
				<div class="player offset-0" data-scrollreveal="enter right">
					...
					<div class="teampicture">
						<img src="images/team4.jpg" class="fwi dajy" alt=""/>
						<div class="teamover"></div>
						<p>CEO</p>
					</div>
					<div class="socialiconswhite m20">
...
<!-- SECTION IMAGE -->
<section class="bgmaincolor cwhite relative z100 clearfix">
	<div class="cover1b col-xs-12 col-sm-12 col-md-5 col-md-offset-7 h700" >&nbsp;</div>
	<div class="container cus-pos-abs">
		<div class="clearfix"></div>
		<div class=" col-sm-12 col-sm-offset-0 col-md-7  sspacing offset-0">
			<h1 class="titlefont cdarg caps">Here is a list of awesome things that this theme can achieve</h1>
			<p class="size20 mt20">
				The profesional business template that once you've seen it you will never forget. 
			</p>
			<div class="separator100 bgwhite mtb30"></div>
...
<div class="">
	<div class="container sspacing">
		<div class="row">
			...
			<div class="col-md-6">
				<h3 class="caps size40 pb20 titlefont">Take your business in your pocket. Do it mobile!</h3>
			...
			<div class="col-md-3" data-scroll-reveal="enter top over 1s and move 0px after 0.2s">
				<div class="circlesmall-maincolor left"><i class="icon-child"></i></div>
				<div class="ctnr">
			...
			<div class="col-md-3" data-scroll-reveal="enter top over 1s and move 0px after 0.4s">
				<div class="circlesmall-maincolor left"><i class="icon-network"></i></div>
				<div class="ctnr">
			...
			<div class="col-md-3" data-scroll-reveal="enter top over 1s and move 0px after 0.6s">
				<div class="circlesmall-maincolor left"><i class="icon-shield"></i></div>
				<div class="ctnr">
			...
			<div class="col-md-3" data-scroll-reveal="enter top over 1s and move 0px after 0.8s">
				<div class="circlesmall-maincolor left"><i class="icon-ok"></i></div>
				<div class="ctnr">
...
<!-- CAROUSEL -->
<div class="">
	<div class="pt50 text-center">
		<h3 class="text-center caps pb20 titlefont">From the blog</h3>

		<!-- CarouFredSel 4 -->
		<div class="list_carousel5 responsive">
			<ul id="foo5" class="max4">
				<li class="pfover">
					<a href="images/carousel5/thumb5.jpg" data-rel="lightcase:myCollection" class="circlebig2"><i class="icon-article-alt"></i></a>
					<a href="images/carousel5/thumb5.jpg" data-rel="lightcase:myCollection2"><img src="images/carousel5/thumb5.jpg" class="wdhover" alt=""/></a>
					<div class="caption">
				...
				<li class="pfover">
					<a href="images/carousel5/thumb12.jpg" data-rel="lightcase:myCollection" class="circlebig2"><i class="icon-article-alt"></i></a>
					<a href="images/carousel5/thumb12.jpg" data-rel="lightcase:myCollection2"><img src="images/carousel5/thumb12.jpg" class="wdhover" alt=""/></a>
					<div class="caption">
						<p class="title">Add Caption Title</p>
						Your caption description goes here...
					</div>					
				...
				<li class="pfover">
					<a href="images/carousel5/thumb3.jpg" data-rel="lightcase:myCollection" class="circlebig2"><i class="icon-article-alt"></i></a>
					<a href="images/carousel5/thumb3.jpg" data-rel="lightcase:myCollection2"><img src="images/carousel5/thumb3.jpg" class="wdhover" alt=""/></a>
					<div class="caption">
						<p class="title">Add Caption Title</p>
						Your caption description goes here...
					</div>					
				...
				<li class="pfover">
					<a href="images/carousel5/thumb10.jpg" data-rel="lightcase:myCollection" class="circlebig2"><i class="icon-article-alt"></i></a>
					<a href="images/carousel5/thumb10.jpg" data-rel="lightcase:myCollection2"><img src="images/carousel5/thumb10.jpg" class="wdhover" alt=""/></a>
					<div class="caption">
						<p class="title">Add Caption Title</p>
						Your caption description goes here...
					</div>					
				...
				<li class="pfover">
					<a href="images/carousel5/thumb6.jpg" data-rel="lightcase:myCollection" class="circlebig2"><i class="icon-article-alt"></i></a>
					<a href="images/carousel5/thumb6.jpg" data-rel="lightcase:myCollection2"><img src="images/carousel5/thumb6.jpg" class="wdhover" alt=""/></a>
					<div class="caption">
						<p class="title">Add Caption Title</p>
						Your caption description goes here...
					</div>					
...
<section class="">
	<div class="container mtb80">
		<div class="row">
			...
			<!-- PRICE TABLE -->
			<div class="pricelist-wrapper dark col4 h500">
				<ul>
					...
					<li class="plistselected">
						...
						<div class="plistrow2"><span class="h9">€9.99</span><br><span class="smallp clight">/month</span></div>
						<div class="plistrowbg">10</div>
						<div class="plistrow pchecked"><img alt="" src="images/spacer.png"></div>
						<div class="plistrowbg punvailable"><img alt="" src="images/spacer.png"></div>
						<div class="plistrow pchecked"><img alt="" src="images/spacer.png"></div>
						<div class="plistrowbg punvailable"><img alt="" src="images/spacer.png"></div>
					...
					<li class="noselections">
						...
						<div class="plistrow2"><span class="h9">€29.99</span><br><span class="smallp clight">/month</span></div>
					...
					<li class="noselections">
						...
						<div class="plistrow2"><span class="h9">€39.99</span><br><span class="smallp clight">/month</span></div>
						<div class="plistrowbg">500</div>
						<div class="plistrow pchecked"><img alt="" src="images/spacer.png"></div>
						<div class="plistrowbg">Unlimited</div>
						<div class="plistrow pchecked"><img alt="" src="images/spacer.png"></div>
						<div class="plistrowbg pchecked"><img alt="" src="images/spacer.png"></div>
						<div class="plistrow2"><div class="button_ok"><a href="#">Buy</a></div></div>
					</li>
				</ul>
			</div>
...
<!-- Connection Tree animation - This loads the connection animation from page 8 and 9 -->
<script type="text/javascript" src="js/codrops/connections/TweenLite.min.js"></script>
<script type="text/javascript" src="js/codrops/connections/EasePack.min.js"></script>
<script type="text/javascript" src="js/codrops/connections/rAF.js"></script>
<script type="text/javascript" src="js/codrops/connections/tree.js"></script>
